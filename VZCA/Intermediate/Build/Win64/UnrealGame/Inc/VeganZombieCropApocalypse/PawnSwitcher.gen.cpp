...
// End Cross Module References
	DEFINE_FUNCTION(UPawnSwitcher::execBlendCamera)
	{
		P_FINISH;
		P_NATIVE_BEGIN;
		P_THIS->BlendCamera();
	...
	void UPawnSwitcher::StaticRegisterNativesUPawnSwitcher()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "BlendCamera", &UPawnSwitcher::execBlendCamera },
			{ "SwitchPawn", &UPawnSwitcher::execSwitchPawn },
		};
		FNativeFunctionRegistrar::RegisterFunctions(Class, Funcs, UE_ARRAY_COUNT(Funcs));
	}
	struct Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics
	{
#if WITH_METADATA
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics::Function_MetaDataParams[] = {
		{ "ModuleRelativePath", "PawnSwitcher.h" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UPawnSwitcher, nullptr, "BlendCamera", nullptr, nullptr, 0, nullptr, 0, RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04020401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UPawnSwitcher_BlendCamera()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UPawnSwitcher_BlendCamera_Statics::FuncParams);
		}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UPawnSwitcher_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UPawnSwitcher_BlendCamera, "BlendCamera" }, // 233473887
	...
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_CurrentPawnTag_MetaData[] = {
		...
		{ "Comment", "// A variable that stores the tag for the current pawn\n" },
		{ "ModuleRelativePath", "PawnSwitcher.h" },
		{ "ToolTip", "A variable that stores the tag for the current pawn" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_CurrentPawnTag = { "CurrentPawnTag", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPawnSwitcher, CurrentPawnTag), METADATA_PARAMS(Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_CurrentPawnTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_CurrentPawnTag_MetaData)) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_OtherPawnTag_MetaData[] = {
		{ "Category", "Pawn Switcher Tags" },
		{ "Comment", "// A variable that stores the tag for the other pawn\n" },
		{ "ModuleRelativePath", "PawnSwitcher.h" },
		{ "ToolTip", "A variable that stores the tag for the other pawn" },
	};
#endif
	const UECodeGen_Private::FNamePropertyParams Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_OtherPawnTag = { "OtherPawnTag", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Name, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(UPawnSwitcher, OtherPawnTag), METADATA_PARAMS(Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_OtherPawnTag_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_UPawnSwitcher_Statics::NewProp_OtherPawnTag_MetaData)) };
#if WITH_METADATA
	...
	struct Z_CompiledInDeferFile_FID_VZCA_Source_VeganZombieCropApocalypse_PawnSwitcher_h_Statics
	{
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VZCA_Source_VeganZombieCropApocalypse_PawnSwitcher_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UPawnSwitcher, UPawnSwitcher::StaticClass, TEXT("UPawnSwitcher"), &Z_Registration_Info_UClass_UPawnSwitcher, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPawnSwitcher), 908717425U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_VZCA_Source_VeganZombieCropApocalypse_PawnSwitcher_h_4216678913(TEXT("/Script/VeganZombieCropApocalypse"),
		Z_CompiledInDeferFile_FID_VZCA_Source_VeganZombieCropApocalypse_PawnSwitcher_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_VZCA_Source_VeganZombieCropApocalypse_PawnSwitcher_h_Statics::ClassInfo),
		nullptr, 0,
		nullptr, 0);
